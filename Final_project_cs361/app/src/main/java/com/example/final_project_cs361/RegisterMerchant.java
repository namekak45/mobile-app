...
//        }
        ...
        mRegisStoreTypeTableC = (CheckBox)findViewById(R.id.regis_store_type_table_c);
        mRegisStoreTypeTableD = (CheckBox)findViewById(R.id.regis_store_type_table_d);
        mRegisStoreTypeTableE = (CheckBox)findViewById(R.id.regis_store_type_table_e);
...
//                        Toast.makeText(MainActivity.this, msg, Toast.LENGTH_SHORT).show();
    ...
    public void saveMerchant(View view) {
        ...
        if (va == true) {
            ...
            if (mRegisStoreTypeTableC.isChecked()) {
                lanes.put("C", 6);
            }
            if (mRegisStoreTypeTableD.isChecked()) {
                lanes.put("D", 8);
            }
            if (mRegisStoreTypeTableE.isChecked()) {
                lanes.put("E", 9);
            }
